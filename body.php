                        ...
                        echo "
								...
								<div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>Ksh $pro_price<del class='product-old-price'>Ksh 0</del></h4>
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id AND product_quantity > 0 ORDER BY RAND()";
                $run_query = mysqli_query($con,$product_query);
                if(mysqli_num_rows($run_query) > 0){
                        ...
                        echo "
								...
								<div class='product'>
									...
									<div class='product-body'>
										<p class='product-category'>$cat_name</p>
										<h3 class='product-name header-cart-item-name'><a href='product.php?p=$pro_id'>$pro_title</a></h3>
										<h4 class='product-price header-cart-item-info'>Ksh $pro_price<del class='product-old-price'>Ksh 990.00</del></h4>
										<div class='product-rating'>";
										$rating_query = "SELECT ROUND(AVG(rating),1) AS avg_rating  FROM reviews WHERE product_id='$pro_id '";
										$run_review_query = mysqli_query($con,$rating_query);
										$review_row = mysqli_fetch_array($run_review_query);
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">KSh 980.00 <del class="product-old-price">Ksh 990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
