					...
					<?php 
							...
							<div class="col-md-5">
								<div class="product-details">
									...
									<div>
										<h3 class="product-price">Ksh '.$row['product_price'].'<del class="product-old-price">$Ksh .00</del></h3>
										<span class="product-available">'.$row['product_quantity'].' In Stock</span>
									</div>
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab2" class="tab-pane fade in">
									<div class="row">
										<div class="col-md-12">
											<p>this is a cool white shirt that can be worn in any occassion</p>
										</div>
									</div>
								</div>
								<!-- /tab2  -->
