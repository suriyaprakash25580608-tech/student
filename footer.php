						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>Kenya, Voi</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+2547 2344465767</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>natalie@gmail.com</a></li>
								</ul>
							</div>
						</div>
